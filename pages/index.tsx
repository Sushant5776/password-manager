...
const Home: NextPage = () => {
  ...
  return (
    ...
    >
      ...
      <main className="bg-white/95 sm:bg-white/[0.93] space-y-6 sm:space-y-9 flex flex-col w-full min-h-screen">
        ...
        <div className="flex flex-1 flex-col space-y-4 sm:space-y-0 sm:flex-row items-center justify-between sm:justify-around h-fit">
          {/* Heading */}
          <h2 className="sm:font-semibold font-medium sm:my-0 my-2 text-center sm:text-left text-rakhadi leading-[4.175rem] sm:leading-[5rem] drop-shadow-lg text-5xl sm:text-6xl w-[14rem] sm:w-[17rem]">
