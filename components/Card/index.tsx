...
const Card = ({ title, id, pass_key }: CardProps) => {
  return (
    <section className="p-4 border backdrop-blur-3xl shadow-md border-rakhadi/50 max-w-xs w-max rounded-md">
      {/* Card Heading */}
      ...
      <form className="space-y-4">
        <CardInput inputValue={id} type="id" displayText="Identity" />
        <CardInput
          inputValue={pass_key}
          type="pass"
